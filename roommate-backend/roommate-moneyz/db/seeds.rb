...
Bill.create(name: "Water", total: 40.0, category: "Utilities", due_date: "Feb 01, 2018", owner_id: 1)
Bill.create(name: "Internet", total: 60.0, category: "Utilities", due_date: "Jan 31, 2018", owner_id: 2)

PayerBill.create(bill_id: 1, payer_id: 2, amount: 30.0)
PayerBill.create(bill_id: 1, payer_id: 3, amount: 30.0)
PayerBill.create(bill_id: 2, payer_id: 2, amount: 10.0)
PayerBill.create(bill_id: 2, payer_id: 3, amount: 10.0)
PayerBill.create(bill_id: 3, payer_id: 1, amount: 20.0)
PayerBill.create(bill_id: 3, payer_id: 3, amount: 20.0)
